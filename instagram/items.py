...
class InstaFollow(scrapy.Item):
    ...
    pictures = scrapy.Field()
    #mutual_friend = scrapy.Field()

class InstaFollowedBy(scrapy.Item):
    _id = scrapy.Field()
    date_parse = scrapy.Field()
    user_name = scrapy.Field()
    user_id = scrapy.Field()
...
class InstaMutualFriends(scrapy.Item):
    _id = scrapy.Field()
    date_parse = scrapy.Field()
    user_name = scrapy.Field()
    user_id = scrapy.Field()
    mutual_friends_name = scrapy.Field()
    mutual_friends_id = scrapy.Field()
    pictures = scrapy.Field()
